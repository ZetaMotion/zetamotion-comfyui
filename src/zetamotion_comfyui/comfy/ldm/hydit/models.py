...
from zetamotion_comfyui.comfy.ldm.modules.diffusionmodules.mmdit import Mlp, TimestepEmbedder, PatchEmbed
from zetamotion_comfyui.comfy.ldm.modules.diffusionmodules.util import timestep_embedding
...
class HunYuanDiT(nn.Module):
    ...
    def forward(self,
        ...
        padding = zetamotion_comfyui.comfy.ops.cast_to_input(self.text_embedding_padding, text_states)
